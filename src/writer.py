...
def build_user_prompt(
    ...
    if topic_key == "building_in_public":
        prompt_parts.append(
            ...
            "- CRITICAL: the hours/percentages/sessions/tokens/cost are on the CARD. Keep them OUT of the "
            "text. Do NOT recite stats. At most ONE number, in words, and only if it genuinely makes a point "
            "('barely touched code till Thursday') — never a list of figures. A stat dump is exactly what "
            "makes these posts feel hollow. Avoid it.\n"
