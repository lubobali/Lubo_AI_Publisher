...
- Remaining before live: a 7-day full E2E dry run through the real Pipeline (all 7 categories, real scrape+dedup+screenshot+KB), then Phase 3 (React dashboard publisher.lubobali.com + first real LinkedIn post).
