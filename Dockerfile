...
# Build deps (psycopg2) + postgresql-client (pg_dump for B2 backups) + Chromium runtime
# libs (Debian names — Playwright's --with-deps assumes Ubuntu and fails on python:slim).
